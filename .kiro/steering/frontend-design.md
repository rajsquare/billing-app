...
This steering file guides creation of distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics. Implement real working code with exceptional attention to aesthetic details and creative choices.

## When to Apply

Apply this guidance when creating or modifying:
- Web components, pages, or applications
- Landing pages, dashboards, React components
- HTML/CSS layouts or any web UI styling/beautifying work
