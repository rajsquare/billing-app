  ...
  return `
    <div class="invoice-box-unit">
      ...
      <div class="print-wrapper receipt-copy" style="position:relative;">
        <div class="copy-label office-copy-label" style="background-color:#000000;color:#ffffff;display:inline-block;width:auto;box-sizing:border-box;">OFFICE COPY</div>
  ...
  return `
    <div class="invoice-box-unit">
      ...
      <div class="print-wrapper receipt-copy">
        <div class="copy-label${label === 'OFFICE COPY' ? ' office-copy-label' : ''}" ${label === 'OFFICE COPY' ? 'style="background-color:#000000;color:#ffffff;display:inline-block;width:auto;box-sizing:border-box;"' : ''}>${label}</div>
